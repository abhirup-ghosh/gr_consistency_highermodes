...
\begin{figure}[htb] 
	...
	\end{center} 
\caption{Same as Figure~\ref{fig:posterior_spin} but for high primary component spins. We can see that the width of the deviation parameters increase significantly. \ajitm{I will put a better picture latter.}}
