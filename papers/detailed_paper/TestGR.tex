...
We now elaborate on the two formulations of the tests presented in Sec.~\ref{sec:test} and present results from simulated observations of binary black holes in GR. Our strategy, as described earlier, is to introduce extra parameters in the higher order modes of radiation --- parameters describing inconsistency between different modes --- and to constrain them using a Bayesian framework. 
