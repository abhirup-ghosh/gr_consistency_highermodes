...
\caption{Same as Fig~\ref{fig:posterior_BBH_GR_inj}, except that the simulated GW signal corresponds to a binary containing at least one compact object other than a black hole. The signal was produced by rescaling a numerical-relativity waveform from a neutron-star-black-hole binary with mass ratio $1/6$ to a total mass of $120 M_\odot$ (inclination angle $\iota = \red{x}$, producing SNR = \red{xx} in Advanced LIGO.)}
