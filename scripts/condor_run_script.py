...
for M in M_list:
  for iota in iota_list:
	...
	out_dir = '/home/abhirup/Documents/Work/gr_consistency_highermodes/runs/9_param_runs_3det_real_ampcorr/Mc_q_c3_c4_diffM/M_%.2f_q_0.11_iota_%d'%(M, iota_map[iota])
	...
	sh_script.write("python /home/abhirup/Documents/Work/gr_consistency_highermodes/scripts/emcee_inference_tgr_real_amp_corr_c3_c4_tousif.py -H %s/GR_M_%.2f_q_0.11_iota_%.2f_flow_20Hz_H1.dat -L %s/GR_M_%.2f_q_0.11_iota_%.2f_flow_20Hz_L1.dat -V %s/GR_M_%.2f_q_0.11_iota_%.2f_flow_20Hz_V1.dat -i %s/GR_M_%.2f_q_0.11_iota_%.2f_flow_20Hz_ampcorr_real_c3_c4_initial.dat -o %s\n"%(data_dir, M, iota, data_dir, M, iota, data_dir, M, iota, data_dir, M, iota, out_dir))
	sh_script.close()
...
for q in q_list:
  for iota in iota_list:
        data_dir = '/home/abhirup/Documents/Work/gr_consistency_highermodes/injections/9_param_runs_3det'
        out_dir = '/home/abhirup/Documents/Work/gr_consistency_highermodes/runs/9_param_runs_3det_real_ampcorr/Mc_q_c3_c4_diffq/M_40.00_q_%.2f_iota_%d'%(q, iota_map[iota])
        os.system('mkdir -p %s'%out_dir)
        ...
        sh_script.write("source ~/.bashrc\n")
        sh_script.write("source /home/abhirup/src/pycbc/bin/activate\n")
        sh_script.write("python /home/abhirup/Documents/Work/gr_consistency_highermodes/scripts/emcee_inference_tgr_real_amp_corr_c3_c4_tousif.py -H %s/GR_M_40.00_q_%.2f_iota_%.2f_flow_20Hz_H1.dat -L %s/GR_M_40.00_q_%.2f_iota_%.2f_flow_20Hz_L1.dat -V %s/GR_M_40.00_q_%.2f_iota_%.2f_flow_20Hz_V1.dat -i %s/GR_M_40.00_q_%.2f_iota_%.2f_flow_20Hz_ampcorr_real_c3_c4_initial.dat -o %s\n"%(data_dir, q, iota, data_dir, q, iota, data_dir, q, iota, data_dir, q, iota, out_dir))
        sh_script.close()
